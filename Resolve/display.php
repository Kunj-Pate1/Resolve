...
<body class="bg">
	...
	<a class="navbar-brand" href="adminpg.php" >Go Back</a>
	...
	<tbody>
		...
		?>
				<tr>
					...
					<td class="tab">Priority</td>
					<td class="tab">Pending</td>
					<td class="tab"><a href="resolved.php?id=<?php echo $row['Cid'];?>"><button class='ress' >Resolve</button></a></td>
				</tr>
		<?php	
			}
		?>
