...
<?php
    ...
    if(isset($_POST['Name'])){
        ...
        if($result){
            echo "<p style='background-color:'green''>Form submitted successfully</p>";
        }
        else{
